    ...
    public sealed partial class Plugin : BaseUnityPlugin
    {
        ...
        private void PatchStuff()
        {
            System.Collections.Generic.List<string> Namespaces = new System.Collections.Generic.List<string>
            {
                ...
                typeof(ULTRAKILL.VRPlayer.VRCamera.Patches.A).Namespace,
                typeof(ULTRAKILL.UI.Patches.A).Namespace,
                typeof(ULTRAKILL.VRPlayer.Patches.A).Namespace,
                typeof(ULTRAKILL.VRPlayer.Movement.Patches.A).Namespace,
            };
            System.Collections.Generic.List<System.Type> Types = new System.Collections.Generic.List<System.Type>
            {
                typeof(ULTRAKILL.VRPlayer.Controllers.Patches.ControllerAdder),
                typeof(ULTRAKILL.Input.ControlMessages.Patches)
            };
            if (Vars.Config.Controllers.EnableHaptics) Types.Add(typeof(ULTRAKILL.VRPlayer.Controllers.Patches.ControllerHaptics));
            if (Vars.Config.EnableCBS)                 Namespaces.Add(typeof(ULTRAKILL.VRPlayer.Guns.Patches.A).Namespace);
            if (Vars.Config.EnableMBP)                 Namespaces.Add(typeof(ULTRAKILL.VRPlayer.Arms.Patches.A).Namespace);
            if (!Vars.Config.MBP.CameraWhiplash)       Namespaces.Add(typeof(ULTRAKILL.VRPlayer.Arms.Patches.Whiplash.A).Namespace);
            if (Vars.Config.EnableVRBody)              Namespaces.Add(typeof(ULTRAKILL.VRPlayer.VRAvatar.Patches.A).Namespace);
