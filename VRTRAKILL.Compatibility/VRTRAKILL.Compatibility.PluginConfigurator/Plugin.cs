...
namespace VRTRAKILL.Compatibility.PluginConfigurator
{
    [BepInDependency(PluginConfig.PluginInfo.PLUGIN_GUID, BepInDependency.DependencyFlags.HardDependency)]
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static void Init()
        {
            ...
            PC = PluginConfig.API.PluginConfigurator.Create(VRBasePlugin.PluginInfo.PLUGIN_NAME, VRBasePlugin.PluginInfo.PLUGIN_GUID);
            PC.SetIconWithURL($"file://{VRBasePlugin.PluginInfo.PluginPath}\\icon.png");
            PC.saveToFile = false;
    ...
    internal static class Extensions
    {
        ...
        {
            if (VRBasePlugin.ULTRAKILL.Input.InputMap.UKeys.TryGetValue(O.ToString(), out KeyCode? A))
                return (KeyCode)A;
            else return 0;
        }
    }
