        ...
        public static void CheckForUpdates()
        {
            ...
            try
            {
                using (HttpClient HC = new HttpClient())
                {
                    ...
                    var LatestVersion = JsonConvert.DeserializeObject<VersionJSON>(Stream.Result);
            ...
            {
                Vars.Log.LogError("Unable to check for updates!"); Vars.Log.LogError(E.Message + E.InnerException);
                return;
            }
