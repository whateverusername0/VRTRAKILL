...
namespace VRTRAKILL.Goodies.ThirdPersonCamera
{
    ...
    internal class ThirdPersonCamera : MonoSingleton<ThirdPersonCamera>
    {
        ...
        public void Update()
        {
            Utilities.Unity.CopyCameraValues(TPCam, VRBasePlugin.ULTRAKILL.Vars.DesktopCamera);
        ...
        {
            if (Input.GetKey((KeyCode)VRBasePlugin.ULTRAKILL.Config.ConfigMaster.TPCamHoldMoveMode))
            {
